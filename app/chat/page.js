...
export default function Chat() {
  ...
  const API_KEY = "AIzaSyBMU3UpEDhR5QAE88NT1XHOaw8kG-WB9Fg";
  ...
  const safetySettings = [
    {
      ...
      blockThreshold: HarmBlockThreshold.BLOCK_MEDIUM_AND_ABOVE,
    },
    {
    ...
    <div className={`flex flex-col h-screen p-4 ${primary}`}>
      ...
      <div className="flex items-center mt-4">
        <input
          ...
          className={`flex-1 p-2 rounded-1-md border-t border-b border-1
